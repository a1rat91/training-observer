...
минимальная оценка 80, минимальный отрыв 30. Совпавший ID при противоречащих непустых подписях не считается
доказательством: такой кандидат получает 0. Сгенерированные ID исключаются из сильного признака. Один текущий контрол не
может удовлетворять двум обязательным ожиданиям. Missing/ambiguous блокируют оценку. Значения и координаты не влияют на
выбор кандидата.
