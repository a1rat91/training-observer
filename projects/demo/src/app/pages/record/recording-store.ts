...
export class RecordingStore {
    ...
    load(): void {
        try {
            ...
            this.errorState.set('Не удалось прочитать сохранённую запись. Можно создать новую.');
        }
    }
    ...
    save(recording: StateRecording): void {
        ...
        try {
            ...
            this.errorState.set('Не удалось сохранить запись в браузере. Скопируйте JSON ниже.');
        }
    }
}
