...
import { StateRecorder, removeRecordedEvent, recordingProblem } from '@training-observer/recording';
import { type StateRecording, type RecordedEvent } from '@training-observer/contracts';
    ...
    constructor() {
        ...
        effect(() => {
            ...
            if (
                snapshot &&
                selected &&
                this.screen().controls.some((control) => control.targetNodeId === selected)
            ) {
