/**
 * Вычисление условий сценария без смешивания неизвестного состояния с ложным.
 * Алгоритм: обходит all/any, проверяет pathname либо разрешает target и читает visibility/value.
