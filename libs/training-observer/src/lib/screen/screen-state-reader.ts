...
import type { DomElementSnapshot, DomNodeSnapshot, DomSnapshot } from '@training-observer/core/models';
import type { ScreenState, ScreenStateOptions } from '@training-observer/core/models';
